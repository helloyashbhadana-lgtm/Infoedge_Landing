...
import HeroRevealCanvas from "../../ui/HeroRevealCanvas";
...
function AppIconStack() {
  ...
  return (
    <span className="hero-v2__icon-stack">
      {appIcons.map((icon, i) => {
...
export default function HeroV2() {
  ...
  return (
    <section className="hero-v2">
      <HeroRevealCanvas
        bwSrc="/assets/hero_img_black_bg.png"
        colorSrc="/assets/hero_img_color_bg.png"
        revealRadius={400}
      />
      <div className="hero-v2__content">
        <h1 className="hero-v2__heading">
          <span className="hero-v2__line">
            <motion.span
              className="hero-v2__line-inner"
            ...
            >
              {line1Words.map((word, i) => (
                <Fragment key={i}>
                  <motion.span className="hero-v2__word" variants={wordVariants}>
                    {word}
                  </motion.span>
          ...
          <span className="hero-v2__line">
            <motion.span
              ...
              animate="visible"
            >
              <motion.span className="hero-v2__word" variants={wordVariants}>trusted</motion.span>
              {" "}
              <motion.span className="hero-v2__word" variants={wordVariants}>digital</motion.span>
              {" "}
              <motion.span className="hero-v2__word" variants={wordVariants}>
                <AppIconStack />
              </motion.span>
              {" "}
              <motion.span className="hero-v2__word" variants={wordVariants}>platforms</motion.span>
            </motion.span>
          </span>
        </h1>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6, ease: [0.25, 0.1, 0.25, 1] }}
        >
          <div className="hero-v2__stat-block">
            <span className="hero-v2__stat-number">45,000 Cr.+</span>
            <span className="hero-v2__stat-label">Market cap</span>
          </div>
          <div className="hero-v2__stat-divider" />
          <div className="hero-v2__stat-block">
            <span className="hero-v2__stat-number">50+</span>
            <span className="hero-v2__stat-label">Active Investments</span>
          </div>
          <div className="hero-v2__stat-divider" />
          <div className="hero-v2__stat-block">
            <span className="hero-v2__stat-number">25+ Years</span>
            <span className="hero-v2__stat-label">Building Trust</span>
          </div>
        </motion.div>
      </div>
    </section>
